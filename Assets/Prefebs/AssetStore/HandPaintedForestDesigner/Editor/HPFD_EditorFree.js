...
class ForestDesigner extends EditorWindow {
	...
	@MenuItem ("Window/Forest Designer")
		...
		switch(wizardPage){
			case 0:
				if (runOnceBool){
					...
					buttonBack = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_Back.psd", Texture2D) as Texture2D;
				...
				texture1 = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_Trees.psd", Texture2D) as Texture2D;
				...
				texture1 = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_Plants.psd", Texture2D) as Texture2D;
				if(GUILayout.Button(texture1, GUILayout.Width(200), GUILayout.Height(110))) {
					runOnceBool = true;
				...
				texture1 = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_Rocks.psd", Texture2D) as Texture2D;
				if(GUILayout.Button(texture1, GUILayout.Width(200), GUILayout.Height(110))) {
					runOnceBool = true;
				...
				texture1 = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_Settings.psd", Texture2D) as Texture2D;
				if(GUILayout.Button(texture1, GUILayout.Width(200), GUILayout.Height(110))) {
					runOnceBool = true;
			...
			case 1:
				...
				if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_GenTree.psd", Texture2D) as Texture2D
				...
				if (daMainObject != null){
					...
					if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/PosButtons/PosButton12.png", Texture2D) as Texture2D
											, GUILayout.Width(30), GUILayout.Height(30))) {
						SelectPrevious("Trees");

					}
					if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/PosButtons/PosButton14.png", Texture2D) as Texture2D
											, GUILayout.Width(30), GUILayout.Height(30))) {
						SelectNext("Trees");
					}
					...
					if ( daMainObject.transform.childCount > 0 ){
						GUILayout.BeginArea (Rect (10,140,300,500));
						if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_RandomTree.psd", Texture2D) as Texture2D
											, GUILayout.Width(200), GUILayout.Height(40))) {
							RefreshPosition(daMainObject);
						...
						if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_RandomLeaves.psd", Texture2D) as Texture2D
											, GUILayout.Width(200), GUILayout.Height(40))) {
							if (daMainObject != null){
								PosX = daMainObject.transform.localPosition.x;
								PosY = daMainObject.transform.localPosition.y;
						...
						if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_RandomRoots.psd", Texture2D) as Texture2D
											, GUILayout.Width(200), GUILayout.Height(40))) {
							if (daMainObject != null){
								PosX = daMainObject.transform.localPosition.x;
								PosY = daMainObject.transform.localPosition.y;
						...
						if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_SaveTexture.psd", Texture2D) as Texture2D
										, GUILayout.Width(200), GUILayout.Height(40))) {
							assetCheckBool = false;
							if ( daMainObject.transform.name.Length > 20 ){
								FindIfAssetIsAvailable(daMainObject.transform.name.Substring(0,21), "Assets/HandPaintedForestDesigner/Prefab");
							}
							if (assetCheckBool){
								DeleteAssetsWithName( daMainObject.transform.name.Substring(0,21), "Assets/HandPaintedForestDesigner/SavedImages" );
			...
			case 2:
				...
				GUILayout.BeginArea (Rect (10,50,300,500));
				if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_GenPlant.psd", Texture2D) as Texture2D
									, GUILayout.Width(200), GUILayout.Height(40))) {
				...
				if (daMainObject){
					...
					if (daMainObject.transform.childCount > 0){
						...
						if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_RandomPlant.psd", Texture2D) as Texture2D
											, GUILayout.Width(200), GUILayout.Height(40))) {
							PosX = daMainObject.transform.localPosition.x;
							PosY = daMainObject.transform.localPosition.y;
							PosZ = daMainObject.transform.localPosition.z;
			...
			case 3:
				...
				GUILayout.BeginArea (Rect (10,50,300,500));
				if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_GenRocks.psd", Texture2D) as Texture2D
									, GUILayout.Width(200), GUILayout.Height(40))) {
				...
				if (daMainObject){
					...
					if (daMainObject.transform.childCount > 0){
						GUILayout.BeginArea (Rect (10,150,300,500));
						if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_RandomRocks.psd", Texture2D) as Texture2D
											, GUILayout.Width(200), GUILayout.Height(40))) {
							PosX = daMainObject.transform.localPosition.x;
							PosY = daMainObject.transform.localPosition.y;
							PosZ = daMainObject.transform.localPosition.z;
			...
			case 4:
				...
				if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_SaveAllTextures.psd", Texture2D) as Texture2D
									, GUILayout.Width(200), GUILayout.Height(40))) {
			...
			case 5:
				...
				EditorGUI.DrawPreviewTexture(Rect(10,30,200,200),AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_SaveAllWarning.psd", Texture2D) as Texture2D);
	...
	function GenerateObjectName(daObjectName : String, daRandomizer : boolean, nextDesign : boolean, theSeason : String, daQuality : String, currDesignNum : int, stringOne : String, stringTwo : String){
		...
		switch (daObjectName){
			case "treeRoots":
				mainPath = ( "Assets/HandPaintedForestDesigner/Modular/Trees_" + daEffects );
					if (daRandomizer){
			...
			break;
			case "rocks":
				mainPath = ( "Assets/HandPaintedForestDesigner/Modular/Rocks_" + daEffects );
				if (daRandomizer){
			...
			break;
			case "plants":
				mainPath = ( "Assets/HandPaintedForestDesigner/Modular/Plant_" + daEffects );
				if (daRandomizer){
		...
		if (!assetCheckBool2){
			...
			mainPath = "Assets/HandPaintedForestDesigner/Editor/WizardImages";
		}
	...
	function SaveTextureToFile(fileName : String, daImageSizeX : float, daImageSizeY : float)
	{
		...
		if (AssetDatabase.IsValidFolder("Assets/HandPaintedForestDesigner/Prefab") == false){
			AssetDatabase.CreateFolder("Assets/HandPaintedForestDesigner","Prefab");
		}

		PrefabUtility.CreatePrefab("Assets/HandPaintedForestDesigner/Prefab/" + fileName + ".prefab", daMainObject, ReplacePrefabOptions.Default);
		...
		if (AssetDatabase.IsValidFolder("Assets/HandPaintedForestDesigner/SavedImages") == false){
			AssetDatabase.CreateFolder("Assets/HandPaintedForestDesigner","SavedImages");
		}
		var path : String 	= Application.dataPath + "/HandPaintedForestDesigner/SavedImages/" + fileName + "_HQ" + ".png";
		...
		var importer : TextureImporter 	= AssetImporter.GetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + fileName + "_HQ" + ".png") as TextureImporter;
		...
		AssetDatabase.ImportAsset("Assets/HandPaintedForestDesigner/SavedImages/" + fileName + "_HQ" + ".png", ImportAssetOptions.ForceUpdate);
		...
		switch (defaultQualityInt){
			case 0:
				daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + fileName + "_HQ" + ".png", Sprite) as Sprite;
			break;
			case 1:
				LowerQualityTexture( fileName + "_HQ", fileName + "_MQ", 2 );
				daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + fileName + "_MQ" + ".png", Sprite) as Sprite;
			break;
			case 2:
				LowerQualityTexture( fileName + "_HQ", fileName + "_LQ", 3 );
				daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + fileName + "_LQ" + ".png", Sprite) as Sprite;
			break;
		}
	...
	{
		var primaryTexture = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + textureName + ".png", Sprite) as Sprite;
		...
		if (primaryTexture){
			...
			var path : String 	= Application.dataPath + "/HandPaintedForestDesigner/SavedImages/" + saveFileName + ".png";
			var file 			= new File.Open(path,FileMode.Create);
			var binary 			= new BinaryWriter(file);
			binary.Write(bytes);
			file.Close();
			...
			var importer : TextureImporter 	= AssetImporter.GetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + saveFileName + ".png") as TextureImporter;
			...
			AssetDatabase.ImportAsset("Assets/HandPaintedForestDesigner/SavedImages/" + saveFileName + ".png", ImportAssetOptions.ForceUpdate);	
		}
	}
	...
	function EffectGreyscale(textureName : String, saveFileName : String){
		FindIfAssetIsAvailable(saveFileName, "Assets/HandPaintedForestDesigner/SavedImages");
		if ( !assetCheckBool ){
			var primaryTexture = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + textureName + ".png", Sprite) as Sprite;
			if (primaryTexture){
		...
		daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + saveFileName + ".png", Sprite) as Sprite;
	}
	...
	function AfterSaveMenu(){
		if (daMainObject.GetComponent.<SpriteRenderer>() && daMainObject.GetComponent.<SpriteRenderer>().sprite != null && daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(0,5) == "HPFD_"){
			...
			if (!boolTwo && daMainObject.transform.name.length > 20){
				boolTwo = true;
				FindIfAssetIsAvailable2(daMainObject.transform.name.Substring(0,21), "Assets/HandPaintedForestDesigner/Prefab");
			}
			if ( assetCheckBool2 ){
				if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_MakeEditable.psd", Texture2D) as Texture2D
							, GUILayout.Width(200), GUILayout.Height(40))) {
					PosX = daMainObject.transform.localPosition.x;
					PosY = daMainObject.transform.localPosition.y;
					PosZ = daMainObject.transform.localPosition.z;
					...
					var daCurrIndex : int = daMainObject.transform.GetSiblingIndex();
					DestroyImmediate ( daMainObject.gameObject );
					daMainObject = PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Prefab/" + tempString + ".prefab", (typeof(GameObject)))) as GameObject;
					daMainObject.transform.SetParent(daSubParent.transform, false);
					daMainObject.transform.SetSiblingIndex (daCurrIndex);
			...
			if (daMainObject.GetComponent.<SpriteRenderer>() && daMainObject.GetComponent.<SpriteRenderer>().sprite.name.length >= 24){
				...
				if (daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(21,3) == "_MQ" || 
					...
					if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_QualityH.psd", Texture2D) as Texture2D
								, GUILayout.Width(200), GUILayout.Height(40))) {
						FindIfAssetIsAvailable(daMainObject.transform.name.Substring(0,21) + "_HQ", "Assets/HandPaintedForestDesigner/SavedImages");
						if (assetCheckBool){
							daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + daMainObject.transform.name.Substring(0,21) + "_HQ" + ".png", Sprite) as Sprite;
						}
						boolTwo = false;
					}
				}
				if (daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(21,3) == "_HQ" || 
					daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(21,3) == "_LQ" ){
					if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_QualityM.psd", Texture2D) as Texture2D
								, GUILayout.Width(200), GUILayout.Height(40))) {
						FindIfAssetIsAvailable(daMainObject.transform.name.Substring(0,21) + "_MQ", "Assets/HandPaintedForestDesigner/SavedImages");
						if (!assetCheckBool){
							LowerQualityTexture( daMainObject.transform.name.Substring(0,21) + "_HQ", daMainObject.transform.name.Substring(0,21) + "_MQ", 2 );
						}
						daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + daMainObject.transform.name.Substring(0,21) + "_MQ" + ".png", Sprite) as Sprite;
						boolTwo = false;
					}
				}
				if (daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(21,3) == "_HQ" || 
					daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(21,3) == "_MQ" ){
					if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_QualityL.psd", Texture2D) as Texture2D
								, GUILayout.Width(200), GUILayout.Height(40))) {
						FindIfAssetIsAvailable(daMainObject.transform.name.Substring(0,21) + "_LQ", "Assets/HandPaintedForestDesigner/SavedImages");
						if (!assetCheckBool){
							LowerQualityTexture( daMainObject.transform.name.Substring(0,21) + "_HQ", daMainObject.transform.name.Substring(0,21) + "_LQ", 3 );
						}
						daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + daMainObject.transform.name.Substring(0,21) + "_LQ" + ".png", Sprite) as Sprite;
						boolTwo = false;
					}
				}
				if (daMainObject.GetComponent.<SpriteRenderer>().sprite.name.length == 25){
					if (daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(24,1) == "G"){
						if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_ChangeNormal.psd", Texture2D) as Texture2D
									, GUILayout.Width(200), GUILayout.Height(40))) {
							FindIfAssetIsAvailable(daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(0,24), "Assets/HandPaintedForestDesigner/SavedImages");
							if (assetCheckBool){
								daMainObject.GetComponent.<SpriteRenderer>().sprite = AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/SavedImages/" + daMainObject.GetComponent.<SpriteRenderer>().sprite.name.Substring(0,24) + ".png", Sprite) as Sprite;
							}
							boolTwo = false;
						}
					}
				} else {
					if(GUILayout.Button(AssetDatabase.LoadAssetAtPath("Assets/HandPaintedForestDesigner/Editor/WizardImages/Btn_Greyscale.psd", Texture2D) as Texture2D
									, GUILayout.Width(200), GUILayout.Height(40))) {
